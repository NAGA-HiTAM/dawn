...
def create_session(proxy=None, use_proxy=False):
...
def banner():
 ...
 / // // __ || |/ |/ //    /                            
/____//_/ |_||__/|__//_/|_/  
https://chat.whatsapp.com/Fpyxyco4wcVF4lqhLbq7R5
  _   __ ___    __    ____ ___   ___  ______ ____   ___ 
 | | / // _ |  / /   /  _// _ \ / _ |/_  __// __ \ / _ \
 | |/ // __ | / /__ _/ / / // // __ | / /  / /_/ // , _/
 |___//_/ |_|/____//___//____//_/ |_|/_/   \____//_/|_|  
 Gift Coffee FaucetPay : Officialomgode@outlook.com                                                                                 
    """ + Style.BRIGHT)
...
async def main():
    ...
    while True:
        ...
        for account_index, account in enumerate(accounts):
            email = account["email"]
            token = account["token"]
            proxy = proxies[account_index % len(proxies)] if use_proxy else None
            session = create_session(proxy=f"socks5://{proxy}" if proxy else None, use_proxy=use_proxy)
